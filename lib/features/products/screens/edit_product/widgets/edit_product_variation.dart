...
class EditProductVariation extends StatelessWidget {
  const EditProductVariation({super.key, required this.product,});
        ...
        Row(
          ...
          children: [
            AriloRoundedImage(
              ...
              image:
                  'assets/images/imagedefulticon.png', //show good one change it bottom
            ),
          ],
        ), // Row
        SizedBox(height: 32),
